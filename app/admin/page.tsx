...
export default function AdminPage() {
  ...
  const handleSaveProduct = async () => {
    ...
    try {
      // Enforce minimum price of $0.50
      const MIN_PRICE = 0.50
      if (editingProduct.price < MIN_PRICE) {
        editingProduct.price = MIN_PRICE
      }
      ...
      const hasXSS = (editingProduct.name && (editingProduct.name.includes('<svg') || editingProduct.name.includes('<script') || editingProduct.name.includes('<img') || editingProduct.name.includes('onload=') || editingProduct.name.includes('onerror='))) ||
                     (editingProduct.description && (editingProduct.description.includes('<svg') || editingProduct.description.includes('<script') || editingProduct.description.includes('<img') || editingProduct.description.includes('onload=') || editingProduct.description.includes('onerror=')))
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-900"
                          />
                          <p className="text-xs text-gray-500 mt-1">Minimum price: $0.50</p>
                        </div>
                        <div className="flex gap-2">
                          <button
