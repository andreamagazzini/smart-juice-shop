...
async function seedDatabase(db: IDBPDatabase<JuiceShopDBSchema>) {
  ...
  // Challenges
  const challenges = [
    { key: 'loginAdmin', name: 'Login Admin', category: 'Broken Authentication', difficulty: 1, description: 'Log in with the admin user account', solved: false },
    { key: 'weakPassword', name: 'Weak Password', category: 'Broken Authentication', difficulty: 1, description: 'Log in with the admin user account using password "admin123"', solved: false },
