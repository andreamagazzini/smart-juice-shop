...
async function seedDatabase(db: IDBPDatabase<JuiceShopDBSchema>) {
  ...
  // Challenges - Organized by OWASP Top 10 Categories
  const challenges = [
    ...
    { key: 'sqlInjectionLogin', name: 'SQL Injection (Login)', category: 'Injection', difficulty: 3, description: 'Log in using SQL injection', solved: false },
    ...
    // Removed persistedXss as it requires a comment system
    ...
    { key: 'loginAdmin', name: 'Login as Admin', category: 'Authentication Failures', difficulty: 1, description: 'Log in with the admin user account', solved: false },
