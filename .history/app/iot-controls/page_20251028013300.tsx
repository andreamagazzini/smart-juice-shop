  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-8">
      <div className="container mx-auto px-4">
        ...
        {/* Security Warning */}
        <div className="max-w-4xl mx-auto mb-6 bg-yellow-50 border-2 border-yellow-300 rounded-2xl p-6">
          <div className="flex items-center gap-3">
            <span className="text-3xl">⚠️</span>
            <div>
              <h3 className="font-bold text-gray-800">Security Notice</h3>
              <p className="text-sm text-gray-600">
                These IoT devices have security vulnerabilities. Try to exploit them!
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Device Information */}
        <div className="max-w-4xl mx-auto mt-8 bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">📖 How to Exploit</h2>
          <div className="space-y-3 text-sm text-gray-700">
            <div className="border-l-4 border-red-500 pl-4">
              <p className="font-semibold">Default Credentials</p>
              <p>Try: username: <code className="bg-gray-100 px-2 py-1 rounded">admin</code> password: <code className="bg-gray-100 px-2 py-1 rounded">admin</code></p>
            </div>
            <div className="border-l-4 border-orange-500 pl-4">
              <p className="font-semibold">Common Defaults</p>
              <p>Try: admin:admin, admin:1234, user:user, or admin:password</p>
            </div>
            <div className="border-l-4 border-yellow-500 pl-4">
              <p className="font-semibold">Missing Authentication</p>
              <p>Some devices can be controlled without any credentials!</p>
            </div>
          </div>
        </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowCredentialsModal(false)}>
            <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl" onClick={(e) => e.stopPropagation()}>
              ...
              <p className="text-xs text-gray-500 mt-4 mb-4">
                💡 Hint: Try default credentials like admin:admin
              </p>
