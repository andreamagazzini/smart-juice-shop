  ...
  const getChallengeHints = (key: string) => {
    const hints: Record<string, string[]> = {
      'loginAdmin': [
        ...
        'Or try special characters in email like: test@admin!# or admin@test!',
        'Or try: test OR true in the email field with any password'
      ],
      'sessionHijacking': [
      ...
      'weakPassword': [
        ...
        'Or try user@juice-shop.com with "password123"',
        'All passwords are stored in plain text (no hashing!)'
      ],
      'plaintextPassword': [
        'Check the admin page Users tab',
        'The admin password "admin123" is shown in plain text',
        'This violates cryptographic best practices'
      ],
      'defaultCredentials': [
        'Try logging in with: admin@admin.com / admin',
        'These are classic default credentials',
        'They should never be used in production systems',
      ...
      'reflectedXss': [
        ...
        'The search results will reflect your input without escaping'
      ],
      'persistedXss': [
        'Find where user input is stored (like feedback/comments)',
        'Enter malicious script that will be persisted in the database',
        'Other users will see your script when they load the page',
        'Look for places where you can submit data that gets displayed to others'
      ],
      'accessAdminSection': [
        'Try accessing /admin directly in the URL'
      ],
      'exposeSensitiveData': [
        'Access the /admin page and click on the Users tab',
        'You\'ll be prompted to enter database credentials',
        'The credentials are shown in the Overview tab',
        'Enter them correctly to access sensitive user data'
      ],
      'negativeOrder': [
        'Add items to cart and go to checkout',
        'Try changing the price to a negative value',
        'Or modify the price to $0.01',
        'Look for cart total calculations and manipulate them'
      ],
      'defaultIoT': [
        'Go to IoT Controls page',
        'Try to control devices that require authentication',
        'Use default credentials like admin:admin or admin:1234',
        'Common defaults: admin:admin, user:user, admin:password'
      ],
      'insecureIoT': [
        'Access IoT Controls page',
        'Some devices can be controlled without authentication',
        'Try controlling lighting or dispensers',
        'These devices accept commands without checking credentials'
      ]
    }
