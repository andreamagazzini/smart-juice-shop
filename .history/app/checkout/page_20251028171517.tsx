    ...
    if (hasNegativePrice || hasModifiedPrice) {
      ...
      if (completed && window.showChallengeToast) {
        window.showChallengeToast(
          'Manipulate Price',
          'You manipulated product prices through improper input validation! Client-side price calculations can be tampered with. Always validate and recalculate prices server-side, never trust client data, and implement integrity checks for sensitive operations.'
        )
      }
    }
