...
export default function AdminPage() {
  ...
  const handleSaveProduct = async () => {
    ...
    try {
      ...
      // Check if product contains XSS payload (using SVG to avoid network errors)
      const hasXSS = (editingProduct.name && (editingProduct.name.includes('<svg') || editingProduct.name.includes('<script') || editingProduct.name.includes('<img') || editingProduct.name.includes('onload='))) ||
                     (editingProduct.description && (editingProduct.description.includes('<svg') || editingProduct.description.includes('<script') || editingProduct.description.includes('<img') || editingProduct.description.includes('onload=')))
