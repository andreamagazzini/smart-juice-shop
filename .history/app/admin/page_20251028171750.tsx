  ...
  useEffect(() => {
    const loadStats = async () => {
      try {
        ...
        // Get actual counts from IndexedDB
    ...
    // Reload stats when tab changes to overview
        ...
        try {
          ...
          if (completed && window.showChallengeToast) {
            window.showChallengeToast(
              ...
              'You found a password stored in plain text! This is a critical Cryptographic Failure. Passwords should always be hashed using strong algorithms like bcrypt, Argon2, or scrypt. Never store passwords in plain text or use weak hashing like MD5 or SHA1.'
            )
          }
        } catch (error) {
          console.error('Error completing challenge:', error)
