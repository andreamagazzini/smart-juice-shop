...
import { createSessionTokenClient } from '@/lib/client-security'
...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    // Fetch real users from browser-db and generate session tokens
    const fetchUsers = async () => {
      try {
        ...
        const usersWithTokens: UserDisplay[] = allUsers.map((user, index) => {
          const fakeAddresses = [
          ...
          const token = createSessionTokenClient(user.id, user.email)
  ...
  const getFakeUsers = (): UserDisplay[] => [
    { 
      ...
      password: 'admin123',
      sessionToken: createSessionTokenClient(1, 'admin@juice-shop.com'),
      role: 'admin', 
    ...
    { 
      ...
      sessionToken: createSessionTokenClient(2, 'user@juice-shop.com'),
      role: 'customer', 
      address: '456 User Avenue, New York, NY 10001', 
      phone: '+1-555-0202', 
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => {
                                ...
                                alert('Session token copied! Try replacing your session cookie with this token.')
                              }}
