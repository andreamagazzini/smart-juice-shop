        ...
        if (email === 'admin@juice-shop.com' && password === 'admin123') {
          ...
          if (completed && window.showChallengeToast) {
            window.showChallengeToast(
              'Login Admin',
              'You successfully logged in as the admin! Now you have access to sensitive areas and data. Websites should protect admin accounts with strong passwords and multi-factor authentication.'
            )
          }
        }
