      ...
      if (data.success) {
        ...
        if (email === 'admin@juice-shop.com' && password === 'admin123') {
          ...
          if (completed && window.showChallengeToast) {
            window.showChallengeToast(
              ...
              'You logged in using default credentials! This is a Security Misconfiguration vulnerability. Default credentials should always be changed during initial setup, and systems should force users to set strong, unique passwords.'
            )
          }
        }
        ...
        if (password === 'admin123') {
          ...
          if (completed && window.showChallengeToast) {
            window.showChallengeToast(
              'Use Weak Password',
              'You exploited a weak password! This is an Authentication Failure. Implement strong password policies: minimum 12 characters, require mixed case, numbers, and special characters. Consider using password strength meters and blocking common passwords.'
            )
          }
        }
