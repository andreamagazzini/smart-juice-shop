...
export default function ScoreBoard() {
  ...
  const getChallengeHints = (key: string) => {
    const hints: Record<string, string[]> = {
      ...
      'weakPassword': [
        'The admin password is "admin123" (stored in plain text!)',
        'Check the browser storage or inspect the network requests'
      ],
      'sqlInjectionLogin': [
      ...
      'accessAdminSection': [
        ...
        'Or look for admin links in the page source',
        'Admin pages might not check authentication properly'
      ],
      'negativeOrder': [
        'Add items to cart',
