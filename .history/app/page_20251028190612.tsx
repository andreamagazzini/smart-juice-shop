    ...
    if (hasSQLInjection) {
      ...
      if (completed && window.showChallengeToast) {
        window.showChallengeToast(
          'Reveal VIP Products',
          'You used SQL injection to reveal hidden VIP products! By injecting "1=1", you bypassed the security filter that was supposed to hide premium items. The search should have validated your input first. Real attacks could steal entire databases this way!'
        )
      }
    }
