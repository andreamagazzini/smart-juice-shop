    ...
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="absolute inset-0 bg-gray-900 bg-opacity-5 backdrop-blur-sm"></div>
          
          {/* Drawer panel */}
          <div 
            className="relative h-full w-[800px] bg-gradient-to-br from-purple-50 to-pink-100 overflow-y-auto shadow-2xl"
