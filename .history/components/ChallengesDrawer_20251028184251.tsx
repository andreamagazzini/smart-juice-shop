...
export default function ChallengesDrawer() {
  ...
  const getChallengeHints = (key: string) => {
    const hints: Record<string, string[]> = {
      ...
      'sqlInjectionSearch': [
        'Notice: Only 5 regular products show up',
        'Some premium VIP products are hidden from search',
      ...
      'negativeOrder': [
        ...
        'Copy the cart, change the "price" values to 0',
        'Type: localStorage.setItem("cart", \'[modified JSON here]\')',
