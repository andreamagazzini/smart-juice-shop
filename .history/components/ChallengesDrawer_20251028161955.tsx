...
export default function ChallengesDrawer() {
  ...
  const loadChallenges = async () => {
    try {
      ...
      console.log('Loading challenges for userId:', userId, 'currentUser:', currentUser)
      
      // Get current user's completed challenges
      const completed = await getCompletedChallenges(userId)
      const keys = completed.map(c => c.challengeId)
      console.log('Completed challenge keys:', keys)
