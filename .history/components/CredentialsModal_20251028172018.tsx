      ...
      // Mark challenge as complete
        ...
        if (completed && window.showChallengeToast) {
          window.showChallengeToast(
            ...
            'You found database passwords openly displayed in the settings! Secret credentials should never be visible in the app, even to admins. It\'s like posting your email password on a sticky note on your monitor.'
          )
        }
