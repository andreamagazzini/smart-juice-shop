    ...
    const checkAuth = async () => {
      try {
        ...
        if (newUser) {
          ...
          const isAdminEmail = newUser.email === 'admin@juice-shop.com' || newUser.email === 'admin@admin.com'
          ...
          if (previousUser && previousUser.email !== completeUser.email) {
            ...
            const completed = await completeChallenge(completeUser.isAdmin ? 1 : 2, 'sessionHijacking')
            if (completed) {
