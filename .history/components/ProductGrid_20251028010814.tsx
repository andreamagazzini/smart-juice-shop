...
export default function ProductGrid({ searchResults, hasSearched }: { searchResults?: any[], hasSearched?: boolean }) {
  ...
  // Use search results if available, otherwise use products
