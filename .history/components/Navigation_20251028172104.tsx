          ...
          if (previousUser && previousUser.email !== completeUser.email) {
            ...
            if (completed) {
              setToast({ 
                ...
                explanation: 'You logged in as someone else by copying their login token! These tokens are like temporary keys that prove you\'re logged in. They should be hidden and protected, not displayed where anyone can copy them.'
              })
            }
          }
